                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label class="mt-radio mt-radio-outline">
                                                        {{ __('coupon::dashboard.coupons.form.packages') }}
                                        ...
                                        <div class="form-group " id="productsSection">
                                            ...
                                            <div class="col-md-9">
                                                <select name="products_ids[]" multiple id="single"
                                                        class="form-control select2" data-name="products_ids[]" data-placeholder="{{ __('coupon::dashboard.coupons.form.all_packages') }}">
