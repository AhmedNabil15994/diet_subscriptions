              ...
              <div class="form-body">
                <div class="row">
                  ...
                  <div class="form-actions col-md-3">
                    ...
                    <button class="btn btn-sm green btn-outline filter-submit margin-bottom" type="submit">
                      <i class="fa fa-search"></i>
                      {{__('apps::dashboard.datatable.search')}}
                    </button>
                    <a class="btn btn-sm red btn-outline filter-cancel" href="{{url(route('dashboard.home'))}}">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="#">
          ...
          <div class="details">
            ...
            <div class="desc">{{ __('apps::dashboard.index.statistics.order_count') }}</div>
          </div>
        </a>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="#">
          ...
          <div class="details">
            ...
            <div class="desc">{{ __('apps::dashboard.index.statistics.orders_total') }}</div>
          </div>
        </a>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="#">
          ...
          <div class="details">
            ...
            <div class="desc">{{ __('apps::dashboard.index.statistics.todayProfit') }}</div>
          </div>
        </a>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="#">
          ...
          <div class="details">
            ...
            <div class="desc">{{ __('apps::dashboard.index.statistics.monthProfit') }}</div>
          </div>
        </a>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2 yellow-gold" href="#">
          ...
          <div class="details">
            ...
            <div class="desc">{{ __('apps::dashboard.index.statistics.yearProfit') }}</div>
          </div>
        </a>
      </div>
          ...
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-green bold uppercase">
                {{ __('apps::dashboard.index.statistics.most_populer_packages') }}
              </span>
            </div>
          </div>
          <div class="portlet-body">
            <div class="mt-element-card mt-card-round mt-element-overlay">
              <div class="row">
                <div class="general-item-list">
                  @php $colors = ['green-sharp','red-haze','blue-sharp'];@endphp
                      ...
                      <a >
                          <div class="dashboard-stat2 ">
                              <div class="display">
                                  <div class="number">
                                      <h3 class="font-{{$color}}">
                                          <small class="font-{{$color}}" style="    font-size: 16px;">
                                              {{$item->title}}
                                          </small>
                                      </h3>
                                      <small>
                              ...
                              <div class="progress-info">
                                  <div class="progress">
                                  <span style="width: 76%;"
                                        class="progress-bar progress-bar-success {{$color}}">
                                      <span class="sr-only"><span
                                                  class="total_contracts_percentage">{{$item->subscriptions_count}}</span></span>
                                  </span>
                                  </div>
                                  <div class="status">
                                      <div class="status-title">
                                        {{__('apps::dashboard.index.statistics.total_subscriptions')}}
                                      </div>
                                      <div class="status-number"><span
                                                  class="total_contracts_percentage">{{$item->subscriptions_count}}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
