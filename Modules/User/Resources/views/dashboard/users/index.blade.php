                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('user::dashboard.users.datatable.subscriped')}}</th>
                                    <th>{{__('user::dashboard.users.index.active_subscriptions_count')}}</th>
    ...
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          columns: [
            ...
            {data: 'subscriped' 	        , className: 'dt-center'},
            {data: 'active_subscriptions_count' 	        , className: 'dt-center'},
...
responsivePriority: 1,              width: '13%',
              ...
              render: function(data, type, full, meta) {
                ...
                @can('edit_subscriptions')
                  // if(full.active_subscriptions_count){
                  //   y = `<a data-area="${full.id}" class="btn btn-sm openSuspendModal yellow" title="Suspend Subscriptions">
