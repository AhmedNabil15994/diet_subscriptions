...
@section('title', __('sliders::dashboard.sliders.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('sliders::dashboard.sliders.routes.index')}}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('sliders::dashboard.sliders.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('sliders::dashboard.sliders.datatable.image')}}</th>
                                    <th>{{__('sliders::dashboard.sliders.datatable.created_at')}}</th>
                                    <th>{{__('sliders::dashboard.sliders.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('sliders::dashboard.sliders.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {
