      ...
      <div class="col-md-9">
        <div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline">
            ...
            <input onchange="paymentModeSwitcher('upay_switch','testModelData_upay')"
              type="radio"
              name="payment_gateway[upayment][payment_mode]"
              value="test_mode"
              @if(setting('payment_gateway','payment_gateway.upayment.payment_mode')
              !='live_mode'
              )
              checked
              @endif>
          ...
          <label onchange="paymentModeSwitcher('upay_switch','liveModelData_upay')"
            ...
            <input type="radio"
              ...
              value="live_mode"
              {{
              setting('payment_gateway','upayment.payment_mode')=='live_mode'
              ?'checked':''}}>
            <span></span>
          </label>
        </div>
...
<div class="row">
  <div class="col-md-7 col-md-offset-2 upay_switch"
    id="testModelData_upay"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][test_mode][MERCHANT_ID]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][test_mode][API_KEY]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][test_mode][USERNAME]"
  ...
  <div class="col-md-7 col-md-offset-2 upay_switch"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][live_mode][MERCHANT_ID]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][live_mode][API_KEY]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][live_mode][USERNAME]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][live_mode][PASSWORD]"
    ...
    <div class="form-group">
      ...
      <input type="text"
        class="form-control"
        name="payment_gateway[upayment][live_mode][IBAN]"
