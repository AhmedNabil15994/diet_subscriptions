...
<div class="form-actions mt-4">
  <div class="col-md-6">
    {!! field()->date('can_order_in', __('package::dashboard.subscriptions.datatable.can_order_in'),isset($can_order_in_date) ? $can_order_in_date : Carbon\Carbon::now()->addDay()->toDateString()) !!}
  </div>
